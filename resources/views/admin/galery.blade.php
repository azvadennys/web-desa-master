...
@section('content')
    ...
    <div class="container">
        <p>
            <a class="btn btn-primary btn-lg btn-block mt-3" href="{{ route('galery.create') }}">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <form action="{{ route('galery.destroy', $post->id) }}" method="POST" class="delete">
                                @csrf
                                @method('delete')
                                <a href="{{ route('galery.edit', $post->id) }}" class="btn btn-primary"><span
