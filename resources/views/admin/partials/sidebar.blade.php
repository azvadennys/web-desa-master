...
<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Admin Talang Kering</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Lembaga</a>
                ...
                <h3 class="menu-title">Galery Desa</h3><!-- /.menu-title -->
                <li>
                    <a href="{{ url('admin/galery') }}"> <i class="menu-icon ti-email"></i>Galery</a>
                </li>
