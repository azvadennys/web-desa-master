...
@section('content')
    <div class="container py-5 mt-5">
        ...
        <header class="text-center mb-5">
            ...
            <p class="font-italic text-muted mb-0">Ini adalah Produk-produk unggulan Desa Talang Kering</p>
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 ">
                    ...
                    <div class="card rounded shadow-sm border-0 mt-4">
                        ...
                        <div class="card-body p-4">
                            <h5><a href="{{ route('products.product', $product->id) }}"
                                    class="text-dark">{{ $product->nama_barang }}</a></h5>
