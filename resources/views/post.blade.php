        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card p-3 mt-2">
                    ...
                    <!-- Date/Time -->
                    <p>Diposting pada {{ $post->created_at->format('d F Y') }} oleh Admin Desa Talang Kering</p>
                    ...
                    <div class="card-body">
                        <form action="{{ url('/comments') }}" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="Nama" class="form-control" name="username"
                                    rows="3">
                                <p class="text-danger">{{ $errors->first('username') }}</p>
                            </div>
                            <div class="form-group">
                                <input type="text" placeholder="Email" class="form-control" name="email" cols="30"
                                    rows="10">
